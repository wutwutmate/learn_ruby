...
describe "multiply" do
  ...
  it "multiplies several numbers" do
    expect(multiply([1,2,5])).to eq(10)
  end
...
describe "factorial" do
  it "computes the factorial of 0" dio
    expects(factorial(0)).to eq(0)
  end
  it "computes the factorial of 1"
    expects(factorial(1)).to eq(1)
  end
  it "computes the factorial of 2"
    expects(factorial(2)).to eq(2)
  end
  it "computes the factorial of 5"
    expects(factorial(5)).to eq(120)
  end
  it "computes the factorial of 10"
    expects(factorial(10)).to eq(3628800)
  end
end
